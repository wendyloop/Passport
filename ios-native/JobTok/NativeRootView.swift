...
struct NativeRootView: View {
    ...
    private func jobSeekerHome() -> some View {
        JobSeekerHomeView(
            ...
            candidateVideos: store.candidateVideos,
            onSetPrimaryVideo: { videoID in Task { await store.setPrimaryCandidateVideo(videoID: videoID) } },
            onDeleteVideo: { videoID in Task { await store.deleteCandidateVideo(videoID: videoID) } },
            onUpdateVideoCaption: { videoID, caption in Task { await store.updateCandidateVideoCaption(videoID: videoID, caption: caption) } },
